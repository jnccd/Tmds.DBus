...
namespace Tmds2.DBus.Tool
{
    ...
    class ProtocolGenerator : IGenerator
    {
        ...
        public string Generate(string ns, IEnumerable<InterfaceDescription> interfaceDescriptions)
        {
            ...
            AppendLine($"using Tmds2.DBus.Protocol;");
        ...
        public string GenerateShared()
        {
            ...
            AppendLine("namespace Tmds2.DBus.Protocol");
            StartBlock();
            ...
            _generatedHandlers.Add(("Tmds2.DBus.Protocol", "org.freedesktop.DBus.Introspectable", "IIntrospectable"));
