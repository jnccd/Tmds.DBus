...
using Tmds2.DBus.Generator;
using VerifyXunit;
using Xunit;

namespace Tmds2.DBus.Generator.Tests;
...
public abstract class TestsBase : VerifyBase
{
    ...
    protected void AssertCompiles(ImmutableArray<GeneratedSourceResult> generatedSources)
    {
        ...
        try
        {
            ...
            // Find the repository root and locate Tmds2.DBus.Protocol project
            var repoRoot = FindRepositoryRoot();
            var protocolProjectPath = System.IO.Path.Combine(repoRoot, "src", "Tmds2.DBus.Protocol", "Tmds2.DBus.Protocol.csproj");
