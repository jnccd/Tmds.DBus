...
namespace Tmds2.DBus.Tests
{
    public class SignalOwnerTests
    {
        ...
        public async Task AddMatchFollowsNameOwner()
        {
            ...
            // Service provider
            using var serviceConnection = new Protocol::Tmds2.DBus.Protocol.DBusConnection(dbusDaemon.Address!);
            await serviceConnection.ConnectAsync();
            await serviceConnection.RequestNameAsync(wellKnownName, Protocol::Tmds2.DBus.Protocol.RequestNameOptions.AllowReplacement);
            ...
            using var evilConnection = new Protocol::Tmds2.DBus.Protocol.DBusConnection(dbusDaemon.Address!);
            ...
            using var service2 = new Protocol::Tmds2.DBus.Protocol.DBusConnection(dbusDaemon.Address!);
            await service2.ConnectAsync();
            await service2.RequestNameAsync(wellKnownName, Protocol::Tmds2.DBus.Protocol.RequestNameOptions.ReplaceExisting);
            ...
            static void SendSignal(Protocol::Tmds2.DBus.Protocol.DBusConnection conn, string message)
            {
        ...
        public async Task MultipleObserversForSameSender()
        {
            ...
            static void SendSignal(Protocol::Tmds2.DBus.Protocol.DBusConnection conn)
            {
                using var writer = conn.GetMessageWriter();
                writer.WriteSignalHeader(
                    path: "/com/example/Object",
