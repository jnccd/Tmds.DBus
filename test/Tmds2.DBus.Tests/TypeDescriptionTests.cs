...
namespace Tmds2.DBus.Tests
{
    public class TypeDescriptionTests
    {
        ...
        public void TypeAndInterfaceDescription()
        {
            ...
            Assert.Equal("Tmds2.DBus.tests.empty", description.Interfaces[0].Name);
            Assert.Equal("Tmds2.DBus.tests.empty2", description.Interfaces[1].Name);
        ...
        [DBusInterface("Tmds2.DBus.tests.personproperties1")]
        interface IPersonProperties1 : IDBusObject
        {
            Task<PersonProperties> GetAllAsync();
        }

        [DBusInterface("Tmds2.DBus.tests.personproperties2", PropertyType = typeof(PersonProperties))]
        interface IPersonProperties2 : IDBusObject
        { }

        [DBusInterface("Tmds2.DBus.tests.empty")]
        interface IEmptyDBusInterface : IDBusObject
        { }
        [DBusInterface("Tmds2.DBus.tests.empty")]
        interface IEmptyDBusInterfaceDuplicate : IDBusObject
        { }
        [DBusInterface("Tmds2.DBus.tests.empty2")]
        ...
        [DBusInterface("Tmds2.DBus.tests.validmethod")]
        ...
        [DBusInterface("Tmds2.DBus.tests.invalidmethod")]
        ...
        [DBusInterface("Tmds2.DBus.tests.validsignal")]
...
#pragma warning restore
        ...
        [DBusInterface("Tmds2.DBus.tests.invalidsignal")]
